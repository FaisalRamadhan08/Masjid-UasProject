                 ...
                 <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 footer-widget footer-widget-contact">
                     ...
                     <div class="footer-widget-content">
                         ...
                         <div class="contact__number d-flex align-items-center mb-30">
                             ...
                             <a href="tel:5565454117" class="color-primary">08986039054</a>
                         </div><!-- /.contact__numbr -->
                         <p class="mb-20">Jl. Cihapit No.8a, Cihapit, Kec. Bandung Wetan, Kota Bandung, Jawa Barat 40114.</p>
         ...
         <div class="container">
             <div class="row">
                 <div class="col-sm-12 col-md-12 col-lg-12 d-flex justify-content-between">
                     ...
                     <p class="mb-0">
                         <span class="color-gray">&copy; 2023 Share, Faisal Mahzuz Jibril</span>
                     </p>
                 </div><!-- /.col-lg-12 -->
             </div><!-- /.row -->
         </div><!-- /.container -->
